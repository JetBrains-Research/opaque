...
def adaptive_clipping(
    ...
    **External Concerns** (intentionally not included):
    - **Noise injection**: User must call gaussian() or gaussian_stateful() before step_fn
    ...
    **Algorithm** (Andrew et al. baseline + optional LR scaling):
        ...
        3. Add Gaussian noise N(0, (σ·C)²I) (external, via gaussian() or gaussian_stateful())
    ...
    Example - Basic usage (Andrew et al. 2021 baseline):
        ...
        ...     noise_fn, noise_state = gaussian_stateful(stddev=stddev, seed=42 + step)
