...
\newcommand{\anoteinline}[1]{\todo[color=purple!30,inline]{AT: #1}}
\newcommand{\cc}[1]{\todo[color=cyan!30,inline]{CC: #1}}
\newcommand{\ccnote}[1]{\todo[color=cyan!30]{CC: #1}}
\newcommand{\tnote}[1]{\todo[color=purple!30]{\tiny TS: #1}}
\newcommand{\tnoteinline}[1]{\todo[color=blue!30,inline]{TS: #1}}
\newcommand{\agnote}[1]{\todo[color=purple!30]{\tiny AG: #1}}
\newcommand{\agnoteinline}[1]{\todo[color=blue!30,inline]{AG: #1}}
\newcommand{\todoinline}[1]{\todo[color=gray!30,inline]{\tiny TODO: #1}}
\newcommand{\mfdpftrl}[1]{MF-DP-FTRL\xspace}
\newcommand{\mm}{\texttt{MM}\xspace}
\newcommand{\mms}{\texttt{MM}s\xspace}
