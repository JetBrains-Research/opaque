...
def assert_pytree_equal(
    ...
    *,
    ...
    Example:
        >>> from opaque.core.distributed import assert_pytree_equal
...
def reduce_scalar(
    ...
    Example:
        >>> from opaque.core.distributed import reduce_scalar
        >>> import torch.distributed as dist
        >>>
...
def gather_tensors(
    ...
    Example:
        >>> from opaque.core.distributed import gather_tensors
        >>> import torch.distributed as dist
        >>>
...
def sync_object(
    ...
    Example:
        ...
        >>> import opaque.core.distributed.state as dist_state
        >>>
        >>> @dataclass
        >>> class TrainingState:
