...
from opaque.api.auditing.attacks._loss import _merge_args, _validate_batch_argnums
...
def gradient_scores(
    ...
    *args: Any,
    ...
    ``-||∇loss(θ₀)||² + ||∇loss(θₜ)||²`` (the gradient norm reduction
    from initial to current model).  This matches the calibration pattern
