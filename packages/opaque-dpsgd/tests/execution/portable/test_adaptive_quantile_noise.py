...
class TestQuantileNoise:
    ...
    def test_quantile_noise_requires_key(self, backend_case):
    ...
    def test_invalid_fraction_noise_std(self, backend_case):
    ...
    def test_quantile_noise_reproducibility(self, backend_case):
    ...
    def test_quantile_noise_different_keys_produce_different_paths(self, backend_case):
    ...
    def test_quantile_noise_affects_adaptation(self, backend_case):
    ...
    def test_state_preserves_key_and_step(self, backend_case):
    ...
    def test_quantile_noise_with_aux_output(self, backend_case):
...
class TestQuantileNoiseClipNorm:
    ...
    def test_clip_norm_unchanged_by_quantile_noise(self, backend_case):
    ...
    def test_clip_norm_matches_initial(self, backend_case):
