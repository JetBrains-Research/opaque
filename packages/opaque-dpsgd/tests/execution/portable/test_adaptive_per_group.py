...
class TestAdaptivePerGroupBasic:
    ...
    def test_accepts_per_group_initial_clipping_norm(self, backend_case):
        """Test that adaptive_clipped_grad accepts PerGroup initial_clipping_norm."""
        loss_fn = _make_per_group_loss_fn()
        params = {
            "a": backend_case.array(
                np.random.RandomState(42).randn(10).astype(np.float32)
            ),
            "b": backend_case.array(
                np.random.RandomState(42).randn(5).astype(np.float32)
            ),
        }
    ...
    def test_per_group_state_is_per_group(self, backend_case):
        ...
        batch_x = backend_case.array(
            np.random.RandomState(42).randn(8, 10).astype(np.float32)
        )
        batch_y = backend_case.array(
            np.random.RandomState(42).randn(8).astype(np.float32)
        )
    ...
    def test_per_group_returns_grads(self, backend_case):
    ...
    def test_per_group_output_bound_metadata(self, backend_case):
...
class TestAdaptivePerGroupConvergence:
    ...
    def test_independent_adaptation(self, backend_case):
        ...
        batch_x = backend_case.array(
            np.random.RandomState(42).randn(16, 5).astype(np.float32)
        )
        batch_y = backend_case.array(
            np.random.RandomState(42).randn(16).astype(np.float32)
        )
    ...
    def test_high_norm_group_threshold_increases(self, backend_case):
...
class TestAdaptivePerGroupDeterministic:
    ...
    def test_deterministic_with_same_key(self, backend_case):
...
class TestAdaptivePerGroupEmptyBatch:
    ...
    def test_empty_batch_preserves_per_group_thresholds(self, backend_case):
        ...
        # Empty batch
        batch_x = backend_case.array(
            np.random.RandomState(42).randn(0, 10).astype(np.float32)
        )
        batch_y = backend_case.array(
            np.random.RandomState(42).randn(0).astype(np.float32)
        )
    ...
    def test_empty_batch_num_clipped_is_dict(self, backend_case):
...
class TestAdaptivePerGroupAux:
    ...
    def test_return_aux_with_per_group(self, backend_case):
    ...
    def test_group_norms_in_aux_without_return_aux(self, backend_case):
...
class TestAdaptivePerGroupValidation:
    ...
    def test_rejects_negative_per_group_value(self, backend_case):
    ...
    def test_state_validation_rejects_negative_next_clipping_norm(self, backend_case):
...
class TestAdaptivePerGroupMicrobatch:
    ...
    def test_microbatch_with_per_group(self, backend_case):
    ...
    def test_no_aux_microbatch_per_group_streams_stats(self, backend_case, monkeypatch):
...
class TestAdaptivePerGroupAccounting:
    ...
    def test_adaclip_num_groups_1_matches_original(self, backend_case):
    ...
    def test_adaclip_num_groups_lowers_effective_nm(self, backend_case):
    ...
    def test_adaclip_num_groups_negligible_cost(self, backend_case):
    ...
    def test_adaclip_num_groups_formula(self, backend_case):
    ...
    def test_adaclip_num_groups_pld(self, backend_case):
    ...
    def test_adaclip_gaussian_num_groups(self, backend_case):
    ...
    def test_adaclip_num_groups_validation(self, backend_case):
...
class TestGroupNormsInAux:
    ...
    def test_group_norms_in_clipped_grad_aux(self, backend_case):
    ...
    def test_group_norms_none_for_scalar_clipping(self, backend_case):
