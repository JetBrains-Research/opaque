...
class TestMpsPeakTracking:
    ...
    def test_reset_peak_memory_releases_cached_blocks(self, monkeypatch):
        """On MPS the reset is an allocator cache flush of the reserved
        high-water mark — heavyweight, for use between measured configs."""
        calls: list[int] = []
