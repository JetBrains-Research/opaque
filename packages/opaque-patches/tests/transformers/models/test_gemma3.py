...
from transformers.models.gemma3.modeling_gemma3 import Gemma3TextConfig, Gemma3ForCausalLM
...
def tiny_model(device):
    ...
    kwargs.update({'head_dim': 16, 'sliding_window': 8, 'sliding_window_pattern': 2, 'num_hidden_layers': 2})
