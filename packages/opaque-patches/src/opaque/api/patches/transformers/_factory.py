...
def make_apply_model_patches(
    *,
    ...
    Returns:
        ...
        previously installed swap. ``fused_linear_cross_entropy`` inherits from
        ``performance`` and installs a wrapper whose optimized branch requires
        a per-call loss-only marker.
    """
