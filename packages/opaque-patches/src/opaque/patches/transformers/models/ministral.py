...
apply_ministral_patches = make_apply_model_patches(
    ...
    module_path=_MODULE_PATH,
    classes={"mlp": "MinistralMLP", "rms_norm": "MinistralRMSNorm", "decoder_layer": "MinistralDecoderLayer", "causal_lm": "MinistralForCausalLM"},
    mlp_kind='swiglu',
    rms_norm_kind='llama',
...
__all__ = ["apply_ministral_patches", "apply_ministral_family_patches"]
