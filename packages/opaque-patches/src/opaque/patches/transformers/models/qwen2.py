...
apply_qwen2_patches = make_apply_model_patches(
    ...
    module_path=_MODULE_PATH,
    classes={"mlp": "Qwen2MLP", "rms_norm": "Qwen2RMSNorm", "decoder_layer": "Qwen2DecoderLayer", "causal_lm": "Qwen2ForCausalLM"},
    mlp_kind='swiglu',
    rms_norm_kind='llama',
...
__all__ = ["apply_qwen2_patches", "apply_qwen2_family_patches"]
