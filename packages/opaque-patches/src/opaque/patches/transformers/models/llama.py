...
apply_llama_patches = make_apply_model_patches(
    ...
    module_path=_MODULE_PATH,
    classes={"mlp": "LlamaMLP", "rms_norm": "LlamaRMSNorm", "decoder_layer": "LlamaDecoderLayer", "causal_lm": "LlamaForCausalLM"},
    mlp_kind='swiglu',
    rms_norm_kind='llama',
...
__all__ = ["apply_llama_patches", "apply_llama_family_patches"]
