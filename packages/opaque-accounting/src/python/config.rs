...
///     mc_resolution (float): Maximum unresolved MC mass (default 1e-6).
...
impl PyDiscretizationConfig {
    #[new]
    #[pyo3(signature = (discretization=1e-4, log_mass_truncation_bound=-50.0, max_grid_size=10_000_000, tail_mass_truncation=1e-15, seed=42, max_conv_grid=32_768, mc_resolution=1e-6, mc_failure_probability=1e-6))]
    fn new(
        discretization: f64,
