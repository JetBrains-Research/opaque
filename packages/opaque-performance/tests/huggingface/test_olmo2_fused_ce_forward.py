...
"""HF-golden checks for OLMo2 fused-CE forward wrapper semantics."""
...
def test_olmo2_fused_wrapper_matches_hf_with_labels_on_cpu():
    """T1: CPU path should be numerically identical to stock HF forward."""
    torch.manual_seed(0)
    base = _tiny_olmo2_for_causal_lm()
...
def test_olmo2_fused_wrapper_matches_hf_logits_to_keep():
