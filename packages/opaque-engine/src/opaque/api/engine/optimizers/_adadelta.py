...
def adadelta(
    ...
    *,
    ...
    def moment(
        ...
        def coefficient(
            g: Any, grad_var: Any, update_var: Any, phi_g_value: float
        ) -> Any:
            corrected_g = (
            ...
            corrected_dx = ops.subtract(
                update_var, 0.0
            )  # preserves backend scalar promotion
            return ops.divide(
                ops.sqrt(ops.add(corrected_dx, eps)), ops.sqrt(ops.add(g_eff, eps))
            )
