...
:func:`opaque.api.engine.clipping.clipped_grad` and :func:`opaque.api.engine.clipping.auto_clipped_grad`.
...
from opaque.api.engine.clipping._auto import auto_clipped_fun
