...
from opaque.api.transformers.patches.peft import apply_peft_model_patches
...
def apply_runtime_patches(
    *, performance: bool = True, compat: bool = True, **kwargs
    ...
    if vmap_grouped_mm:
        try:
            from opaque.api.transformers.patches.runtime.moe import (
    ...
    if empty_batches:
        try:
            from opaque.api.transformers.patches.runtime.collator import (
