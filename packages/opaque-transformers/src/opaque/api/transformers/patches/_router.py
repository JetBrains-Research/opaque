...
from opaque.api.transformers.patches._registry import detect_family, get_family_apply_fn
...
def apply_transformers_model_patches(
    ...
    **kwargs,
    ...
    if dropout and model is not None:
        from opaque.api.transformers.patches.components.dropout import disable_dropout
