...
families::
    ...
    from opaque.api.transformers.patches.families import (make_apply_family_patches, make_apply_model_patches, register_activation_kind)
...
``opaque.transformers.patches.apply_model_patches(model)`` is enough — it discovers
...
from opaque.api.transformers.patches._factory import (
...
from opaque.api.transformers.patches._family import (
    family_name,
    make_apply_family_patches,
)
from opaque.api.transformers.patches._registry import (
    register_family,
    supported_families,
)
