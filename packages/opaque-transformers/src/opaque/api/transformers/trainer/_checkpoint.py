...
# Version 6 removes prefix-accounting checkpoint shapes and records complete
# whole-horizon process provenance for strict resume validation.
DP_STATE_BUNDLE_VERSION = 6
