...
Validates that ``opaque.transformers.trainer._liger.translate_liger_config``
...
from opaque.transformers.trainer._liger import translate_liger_config
...
def test_unknown_keys_are_dropped_with_info_log(caplog):
    ...
    signature)."""
    with caplog.at_level(logging.INFO, logger="opaque.transformers.trainer._liger"):
        out = translate_liger_config(
