"""Real local-process synchronization smoke coverage for MLX MF state."""
...
@pytest.mark.slow
def test_two_process_mf_state_synchronization() -> None:
    ...
    worker = Path(__file__).with_name("_distributed_state_smoke.py")
