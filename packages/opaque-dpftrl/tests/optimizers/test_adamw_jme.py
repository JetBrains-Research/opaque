...
class TestAdamWJME:
    def test_import(self):
        from opaque.dpftrl.optimizers.adamw_jme import adamw_jme, AdamWJMEState  # noqa: F401
    ...
    def test_init_state(self, params):
        from opaque.dpftrl.optimizers.adamw_jme import adamw_jme, AdamWJMEState
