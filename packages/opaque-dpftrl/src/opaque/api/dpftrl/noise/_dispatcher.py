...
- ``_identity.py``: :class:`IdentityMfStrategy`, :func:`identity_mf_strategy`
- ``_band_mf.py``: :class:`BandMfStrategy`, :func:`band_mf_strategy`
- ``_blt.py``: :class:`BltStrategy`, :func:`blt_strategy`
- ``_lambda_cgd.py``: :class:`LambdaCgdStrategy`, :func:`lambda_cgd_strategy`
- ``_bisr.py``: :class:`BisrStrategy`, :func:`bisr_strategy`
- ``_bsr.py``: :class:`BsrStrategy`, :func:`bsr_strategy`
